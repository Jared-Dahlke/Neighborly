...
{   
    ...
    public class HomeController : Controller
    {
        ...
        public void SendText(string phone, string message2)
        {
            ...
            const string accountSid = "ACaf55a28d1e68c66c20e2d1ab236b0132";
            const string authToken = "77887f0f1138647799690b79625c0a97";

            TwilioClient.Init(accountSid, authToken);
            var message = MessageResource.Create(
                body: message2,
                from: new Twilio.Types.PhoneNumber("+16193136629"),
        ...
        public ActionResult Facebook()
        {
            ...
            {
               // client_id = "2085167708402701",     //test app
               //   client_secret = "118a126d99b8426369dc83f378617c8e",     //test app
               client_id = "615898538776983",     //regular app
               client_secret = "c633cf70b906a95889d4377d28c1f7b8",   //regular app
        ...
        {
            string constr = "Server = tcp:jadsolutions.database.windows.net,1433; Initial Catalog = Clients; Persist Security Info = False; User ID = jared.dahlke; Password = Qy1byeqy1bye; MultipleActiveResultSets = False; Encrypt = True; TrustServerCertificate = True; Connection Timeout = 30";
